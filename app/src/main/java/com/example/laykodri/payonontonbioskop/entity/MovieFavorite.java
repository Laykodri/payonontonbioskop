package com.example.laykodri.payonontonbioskop.entity;

import android.database.Cursor;
import android.os.Parcel;
import android.os.Parcelable;

import static com.example.laykodri.payonontonbioskop.database.MovieContract.MovieColumns.MOVIE_ID;
import static com.example.laykodri.payonontonbioskop.database.MovieContract.MovieColumns.MOVIE_IMAGE;
import static com.example.laykodri.payonontonbioskop.database.MovieContract.MovieColumns.MOVIE_TITLE;
import static com.example.laykodri.payonontonbioskop.database.MovieContract.getColumnString;
